...
Now because this project is meant to be public, and it's going on my resume, I had my first opportunity to prevent a data disclosure. In Terraform there are 2 config files called "\*.tfstate\*" and ".tfstate
